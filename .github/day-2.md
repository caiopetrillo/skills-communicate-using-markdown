...
**Meine Antwort:** Git ist eine freie software zur verteilten Versionsverwaltung von Dateien. 

### 2. Was ist GitHub?

**Meine Antwort:** Eine cloudbasierte platform für die Versionsverwaltung und die gemeinsame entwicklung von software

### 3. Was ist der wichtigste Unterschied zwischen Git und GitHub?

**Meine Antwort:** Eins ist die Software zur lokalen versionsverwaltung von code, github ist ein programm der diese git projekte in der cloud speichert und die zusammenarbeit ermöglicht

### 4. Funktioniert Git auch ohne GitHub?

**Meine Antwort:** Ja git funktioniert ohne github

### 5. Was ist ein Repository (Repo)?

**Meine Antwort:** Ein digitaler speicherort für ein Projekt, das die vollständige versionshistorie aller dateien und Verzeichnisse enthält

### 6. Was ist der `main`-Branch?

**Meine Antwort:** Der standart entwicklungsbranch eines repositories der in der Regel den Stabilen und produktionsbereiten Code enthält.

### 7. Was ist Markdown?

**Meine Antwort:** Markdown ist eine einfache Auszeichnungssprache, mit der du Textdateien (meist mit der Endung .md) unkompliziert formatieren kannst.

### 8. Was bedeutet GitHub-Flavoured Markdown (GFM)?

**Meine Antwort:** der spezifische Markdown-Dialekt, der zur Formatierung von Text auf GitHub verwendet wird
